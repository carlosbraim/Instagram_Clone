...
public class AdapterGrid extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        imageLoader.displayImage(urlImagem, viewHolder.imagem, new ImageLoadingListener() {
            ...
            @Override
            public void onLoadingFailed(String imageUri, View view, FailReason failReason) {//erro da biblioteca
            ...
            @Override
            public void onLoadingCancelled(String imageUri, View view) {//erro dentro do app
                viewHolder.progressBar.setVisibility(View.GONE);
            }
        });
