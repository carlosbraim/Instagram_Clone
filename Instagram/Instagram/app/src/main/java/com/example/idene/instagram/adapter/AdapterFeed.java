package com.example.idene.instagram.adapter;
...
import com.example.idene.instagram.activity.ComentariosActivity;
...
import com.example.idene.instagram.model.PostagemCurtida;
        ...
        * */
        ...
        curtidasRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                int qtdCurtidas = 0;
                if ( dataSnapshot.hasChild("qtdCurtidas") ){//caso exista esse nó filho
                    PostagemCurtida postagemCurtida = dataSnapshot.getValue(PostagemCurtida.class);//recuperar a qtd de postagem q temos
                ...
                final PostagemCurtida curtida = new PostagemCurtida();//montar um objeto para passar para o likebutton
